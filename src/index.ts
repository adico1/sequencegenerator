...
export class SequenceGenerator {
    ...
    private static readonly maxNodeId = Math.pow(2, SequenceGenerator.NODE_ID_BITS) - 1 as Int;
    private static readonly maxSequence = Math.pow(2, SequenceGenerator.SEQUENCE_BITS) - 1 as Int;

    // Custom Epoch (January 1, 2015 Midnight UTC = 2015-01-01T00:00:00Z)
    private static readonly CUSTOM_EPOCH: Long = ( process.env.CUSTOM_EPOCH || 1420070400000 ) as Long;
    ...
    public nextId(): Long {
        ...
        if (currentTimestamp === this.lastTimestamp) {
            this.sequence = ((this.sequence + 1) & SequenceGenerator.maxSequence) as Long;
        ...
        let id: Long = ( currentTimestamp << (SequenceGenerator.NODE_ID_BITS + SequenceGenerator.SEQUENCE_BITS) )  as Long;
        id = ( id | (this.nodeId << SequenceGenerator.SEQUENCE_BITS) ) as Long;
        id = ( id | this.sequence )  as Long;
        return (id >>> 0) as Long;
    }
    ...
    private createNodeId(): Int {
      return (new GetMacAddress().getMACAddressHashed() & SequenceGenerator.maxNodeId) as Int;
    }
}
